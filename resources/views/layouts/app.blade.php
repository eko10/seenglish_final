      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview {{ Request::is('elearning*') == true  ? 'active' : '' }}">
            ...
            <ul class="treeview-menu">
              {{-- <li class="{{ Request::is('elearning/soal*') == true  ? 'active' : '' }}"><a href="{{ url('/elearning/soal') }}"><i class="fa fa-circle-o"></i> Soal</a>
          </li> --}}
          <li class="{{ Request::is('elearning/nilai*') == true  ? 'active' : '' }}"><a href="{{ url('/elearning/nilai') }}"><i class="fa fa-circle-o"></i> Nilai</a></li>
        ...
        <li class="treeview {{ Request::is('siswa*') == true  ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            {{-- <li class="{{ Request::is('siswa/ujian*') == true ? 'active' : '' }}"><a href="{{ url('siswa/ujian') }}"><i class="fa fa-circle-o"></i> <span>Ujian</span></a>
        </li> --}}
